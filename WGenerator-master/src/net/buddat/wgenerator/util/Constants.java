...
public class Constants {
	...
	public static final double ORE_ROCK = 75, ORE_IRON = 10, ORE_GOLD = 0.75, ORE_SILVER = 1.25, ORE_ZINC = 1.75,
			ORE_COPPER = 2.25, ORE_LEAD = 2.25, ORE_TIN = 2, ORE_ADDY = 0.75, ORE_GLIMMER = 0.75, ORE_MARBLE = 1.25, ORE_SLATE = 2;
