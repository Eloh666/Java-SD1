...
public class Narrator {
	...
	public static void main(String[] args) {                       // start the program
			ArrayList<String> animals = new ArrayList<String>(); 		   // the list of animals that will be used by the animalsSelection method
			int mode;
	...
	{	
		...
		ArrayList<Animal> animalsList = new ArrayList<Animal>();	  // the list of animal classes that will be used by the Narrator/social methods
